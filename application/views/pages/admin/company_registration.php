                                ...
                                foreach($items as $item){
                                    ...
                                    echo "<tr>";
                                        ...
                                        <td width="12%">
                                            ...
                                            <a href="<?=base_url('update_application/'.$item['company_id']."/Declined");?>" class="btn btn-danger btn-sm" onclick="return confirm('Do you wish to decline this application?');return false;">Decline</a>
                                        </td>
                                        <?php
                                    echo "</tr>";
                                }
