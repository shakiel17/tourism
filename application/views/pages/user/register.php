                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="<?=base_url('register');?>" class="">
                                <h3 class="text-primary"><i class="fa fa-hashtag me-2"></i>STABLISHMENT REGISTER</h3>
                            </a>
                            <!-- <h3>Sign Up</h3> -->
                        </div>
                        <form action="<?=base_url('registration');?>" method="POST">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" name="companyname" id="floatingText" placeholder="jhondoe" required>
                            <label for="floatingText">Stablishment Name</label>
                        </div>
                        <div class="form-floating mb-3">
                            <!-- <input type="email" class="form-control" id="floatingInput" placeholder="name@example.com"> -->
                             <textarea name="description" rows="5" style="width:100%;" id="floatingInput" placeholder="Description"></textarea>
                             <!-- <label for="floatingInput">Description</label> -->
                        </div>
                        <div class="form-floating mb-3">
                            <!-- <input type="email" class="form-control" id="floatingInput" placeholder="name@example.com"> -->
                             <textarea name="address" rows="3" style="width:100%;" id="floatingInput" placeholder="Address" required></textarea>
                             <!-- <label for="floatingInput">Description</label> -->
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingPassword" name="contactno" placeholder="Contact #" required>
                            <label for="floatingPassword">Contact No.</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingPassword" name="email" placeholder="Email" required>
                            <label for="floatingPassword">Email</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingPassword" name="facebook" placeholder="Facebook">
                            <label for="floatingPassword">Facebook Acct</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingPassword" name="loc" placeholder="Location">
                        ...
                        <p class="text-center mb-0"><a href="<?=base_url();?>" class="btn btn-success">Back Home</a></p>
                    </div>
                </div>
            </div>
        </div>
